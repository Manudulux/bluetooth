...
_UART_SERVICE_UUID = bluetooth.UUID("71C1E128-D92F-4FA8-A2B2-0F171DB3436C") #GATT Primary Service Declaration
_UART_RX_CHAR_UUID = bluetooth.UUID("503DD605-9BCB-4F6E-B235-270A57483026") #GATT Characteristic to subscribe for navigation updates
_UART_TX_CHAR_UUID = bluetooth.UUID("00002902-0000-1000-8000-00805f9b34fb") #Client Characteristic Configuration Descriptor (CCCD) ID


class BLESimpleCentral:
    def __init__(self, ble):
        self._ble = ble
        #self._ble.config(mitm=True, le_secure=True, bond=True)
